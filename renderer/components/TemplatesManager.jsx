        ...
        <section className="flex-1 space-y-4">
          ...
          <div className="rounded border border-slate-200 bg-white shadow-sm">
            <header className="border-b border-slate-200 px-4 py-3">
              ...
              <p className="mt-1 text-xs text-slate-500">Import and normalize files used when generating documents.</p>
            </header>
                      ...
                      <div key={definition.key} className="rounded border border-slate-200 px-3 py-3">
                        <div className="flex flex-wrap items-center justify-between gap-2">
                          <div>
                            ...
                            <div className="mt-1 text-xs text-slate-400 break-all">{definition.template_path || 'No template selected yet.'}</div>
                          </div>
