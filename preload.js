...
contextBridge.exposeInMainWorld('api', {
  ...
  getDocuments: async () => [],
  getDocumentDefinitions: async () => [],
  getDocumentDefinition: async () => null,
  saveDocumentDefinition: async () => { throw new Error('Document generation is disabled.'); },
  deleteDocumentDefinition: async () => { throw new Error('Document generation is disabled.'); },
  reorderDocumentDefinitions: async () => { throw new Error('Document generation is disabled.'); },
  getJobsheetTemplateOverrides: async () => [],
  setJobsheetTemplateOverride: async () => { throw new Error('Document generation is disabled.'); },
  clearJobsheetTemplateOverride: async () => { throw new Error('Document generation is disabled.'); },
  addDocument: async () => { throw new Error('Document generation is disabled.'); },
  ...
  emptyDocumentsTrash: async () => { throw new Error('Document generation is disabled.'); },
  ...
  normalizeTemplate: async () => ({ ok: false, message: 'Document generation is disabled.' }),
  inspectWorkbookSheets: async () => [],
