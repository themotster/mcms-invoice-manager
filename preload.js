...
contextBridge.exposeInMainWorld('api', {
  ...
  getJobsheetTemplateOverrides: async (jobsheetId) => await db.getJobsheetTemplateOverrides(jobsheetId),
  ...
  prepareJobsheetTemplateOverride: async (options) => await documentService.prepareJobsheetTemplateOverride(options || {}),
  listDocumentTree: async (options) => await documentService.listDocumentTree(options || {}),
  deleteDocumentFolder: async (options) => await documentService.deleteDocumentFolder(options || {}),
  deleteDocumentByPath: async (options) => await documentService.deleteDocumentByPath(options || {}),
  ...
  inspectWorkbookSheets: async (templatePath) => await documentService.listWorkbookSheets(templatePath),
